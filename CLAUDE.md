...
This is a high-performance Fibonacci calculator implementing multiple algorithms with Clean Architecture principles. The codebase has three main layers:

### Entry Points → Orchestration → Business → Presentation

1. **Entry Points** (`cmd/fibcalc`): CLI main, routes to CLI/REPL modes
...
4. **Presentation** (`internal/cli`): CLI output, REPL, progress bars
